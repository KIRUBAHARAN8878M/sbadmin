...
function Products() {
    ...
    let loadData = async () => {
        setLoading(true);
        let products = await axios.get("https://628209e19fac04c6540df59f.mockapi.io/products");
    ...
    let productDelete = async (id) => {
        try {
            ...
            if (ask) {
                await axios.delete(`https://628209e19fac04c6540df59f.mockapi.io/products/${id}`);
            }
